...
public class GetCumulativeProfitAction extends BaseAction
{
            ...
            HttpServletResponse response) throws IOException, ServletException
    {
        ...
        try
        {
            ...
            LogTools.getInstance().insertLog(DebugLevel.INFO,"Get Cumulative Profit request from User:"+oUserBean.getLogin_name()+", IP:"+request.getRemoteAddr());
