...
public final class CommonDefine
{
    ...
    public static final int SORT_BY_MARKET = 3;
    public static final int SORT_BY_INDICATOR = 4;
    
    //Signal Alert Type
    public static final int NO_ALERT = -1;
    public static final int ALERT_BY_SMS = 1;
    public static final int ALERT_BY_EMAIL = 2;
    
    //Signal Alert Type Name
    public static final String NO_ALERT_NAME = "None";
    public static final String ALERT_BY_SMS_NAME = "SMS";
    public static final String ALERT_BY_EMAIL_NAME = "Email";
}
