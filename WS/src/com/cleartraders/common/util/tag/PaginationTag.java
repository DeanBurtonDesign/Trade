package com.cleartraders.common.util.tag;
...
{
    private static final long serialVersionUID = 4199119510719785703L;
	...
	public String getQueryString(Map map) {
		...
		while (iterator.hasNext()) 
        {
            ...
            if("username".equals(obj) || "password".equals(obj) || "securitycode".equals(obj))
            {
                continue;
            }
